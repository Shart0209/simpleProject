...
type DocsAttrs struct {
	...
	AttrFiles   map[string]interface {
	} `json:"files" db:"files"`
}
...
type UpdDoc struct {
	...
	StartDate   time.Time `form:"start_date" json:"start_date" binding:"required" time_format:"2006-01-02"`
	EndDate     time.Time `form:"end_date" json:"end_date" binding:"required" time_format:"2006-01-02"`
	...
	CategoryID  int       `form:"category" json:"category" binding:"required"`
	AuthorID    int       `form:"author" json:"author" binding:"required"`
	SupplierID  int       `form:"supplier" json:"supplier" binding:"required"`
	GroupsID    int       `form:"group" json:"group" binding:"required"`
}
