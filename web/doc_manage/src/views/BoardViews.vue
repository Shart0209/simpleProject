...
<template>
  <section>
    ...
    <div class="col-md-10 offset-md-1">
      <div class="row justify-content-between gx-2 mb-3">
        <div class="col-sm-4">
          <div class="btn-group" role="group">
            <button v-show="authStore.user.isActive" @click="createForm" type="button"
              class="btn btn-primary me-1">Create</button>
            <button type="button" class="btn btn-primary" @click="refreshForm">Refresh</button>
          </div>
        </div>
        <div class="col-sm-3">
      ...
      :filterKeySP=filterSP 
      :filterKeyGR=filterGR
      :FilterKeyST=FilterKeyStatus 
      />
    </div>
  </section>
